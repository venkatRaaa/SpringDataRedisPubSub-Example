...
public class RedisCustomerInfoPublisher implements CustomerInfoPublisher {
	List<Customer> customers = new ArrayList<>(Arrays.asList(new Customer(1,
			"Jack", "Smith"), new Customer(2, "Adam", "Johnson"), new Customer(
			3, "Kim", "Smith"), new Customer(4, "David", "Williams"),
	...
	public void publish() {
		...
		System.out.println("Publishing... customer with id=" + customer.getId()
